...
backend_args = None
cfg_filename = 'faster-rcnn_ResNeSt'
custom_hooks = [
...
model = dict(
    backbone=dict(
        ...
        depth=50,
        frozen_stages=1,
        init_cfg=dict(checkpoint='open-mmlab://resnest50', type='Pretrained'),
...
work_dir = './work_dirs/faster-rcnn_ResNeSt'
