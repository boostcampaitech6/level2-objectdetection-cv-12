...
class Coco2017Cfg(CocoCfg):
    ...
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='train_2_augmented.json', img_dir='', has_labels=True),
        val=dict(ann_filename='val_2.json', img_dir='', has_labels=True),
        test=dict(ann_filename='test.json', img_dir='', has_labels=False),
        testdev=dict(ann_filename='test.json', img_dir='', has_labels=False),
    ))
